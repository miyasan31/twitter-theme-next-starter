 ...
 * });
 */
export function useAllTweetsQuery(
  baseOptions?: Apollo.QueryHookOptions<AllTweetsQuery, AllTweetsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<AllTweetsQuery, AllTweetsQueryVariables>(AllTweetsDocument, options);
}
export function useAllTweetsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<AllTweetsQuery, AllTweetsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
